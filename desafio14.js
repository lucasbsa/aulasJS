...
console.log( 'Number Objects Array:', numberObject);
// ?
...
numberObject.map(function(item)
{
...
var name = ['l','u','c','a','s'];
var linguaP = name.reduce(function(letra, atual,index,array){
    return letra + atual + 'P';
},'P');
console.log( '\nSeu nome na língua do "P": ',linguaP );
// ?
...
var existe = numberObject.indexOf();

console.log( '\nExiste um { number: 2 } em numberObjects?', existe );
// ?
