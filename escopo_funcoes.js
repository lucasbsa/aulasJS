...
(function(){
    //funcao autoexecutal
    console.log('Funcao autoexecutavel');
...
chamada.
*/
console.log( 'O resultado da subtração é:', sub(function(num1, num2){
    return num1-num2;
}) );
// ?

console.log( 'O resultado da multiplicação é:',mult(function(num1, num2){
    return num1*num2;
}) );
// ?

console.log( 'O resultado da divisão é:',div(function(num1, num2){
    return num1/num2;
}) );
// ?
