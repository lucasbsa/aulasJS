...
/// usar com valores primitivos
// nao usar com objetos

// teste para verificar que tipo é a var if(typeof number1 === 'number')

// testar com typeof bool, string, number
//objeto nao
...
function isOperatorValid(operador){
    if(operation[operador]) return true; //objeto e array
    else return false;

}

console.log('esse e o operador: ', isOperatorValid('/'));
...
function calculator(operador){
    if(isOperatorValid(operador)===false)
        return 'operador inválido!'
            ...
            return function(number1, numero2){
                if(typeof number1 !== 'number'  || typeof numero2 !== 'number')
                    return false;
                    else
                        return operation[operador](number1, numero2);
                
            }

}

console.log('resultado da operação: ', calculator('%')(10,5));
...
console.log('AQUI '+showOperationMessage('+', 10,10));
/*
...
function showErrorMessage(operador){
    if(isOperatorValid(operador)===false)
         ...
         else return 'Operação permitida';
...
if(sum){
  //  sum(number1, number2);
    console.log('resultado: '+showOperationMessage(operationSignal, number1, number2), sum(number1,number2));
}else{
console.log('resultado: '+showErrorMessage(operationSignal));
}
